...
subtitle: "Модель конкуренции двух фирм - вариант 19"
author: "Дмитревская Софья НФИбд-01-19"
...
![График для случая 1](image/1.jpg){ #fig:001 width=80% height=80% }

## Результаты во втором случае
![График для случая 2](image/2.jpg){ #fig:002 width=80% height=80% }
...
1. [Разработка математических моделей конкурентных процессов](https://www.academia.edu/9284004/Наумейко_РАЗРАБОТКА_МАТЕМАТИЧЕСКОЙ_МОДЕЛИ_КОНКУРЕНТНЫХ_ПРОЦЕССОВ)
